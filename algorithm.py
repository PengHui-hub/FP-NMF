...
if __name__ == '__main__':
    ...
    #n_ps is the number of perturbed power spectra (dozens are sufficient), nbinl is the number of \ell bin, number_bin is the number of redshift bin.
    ...
    V = np.load('input_weight.npy')

    # Number of parallel threads, depends on computing resources, default 40.
    n_threads = 40
